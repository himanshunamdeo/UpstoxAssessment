//
//  CryptoCoinsTableViewCell.swift
//  CryptoCoins
//
...
class CryptoCoinsTableViewCell: UITableViewCell {
    ...
    // MARK: - UI Updation
    func updateCell(with viewModel: CryptoCoinsTableViewCellViewModel) {
        ...
        cryptoAcronym.text = viewModel.cryptoAcronyme
    }
}
